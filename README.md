...
| **Agrupación por Perfil de Voto (K-Means)** | Mapa con clustering K-Means (k=4) de las provincias según su comportamiento electoral en 2023. |
| **Ejes Políticos Subyacentes (PCA)** | Biplot de Análisis de Componentes Principales que revela las dimensiones latentes del voto por provincia. |
...
| **Machine Learning** | `stats` (funciones base de R: `kmeans`, `prcomp`) |
...
```
├── dashboard_elecciones.Rmd            # Código fuente (ETL + visualización + ML)
